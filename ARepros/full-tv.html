...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://iraffle.me/api/assets/iraffle/schedule/font-awesome-animation.css">
        ...
        <!--PUSH-POPELLER-->
        <script src="https://propu.sh/pfe/current/tag.min.js?z=3507326" data-cfasync="false" async></script>
        <!--/PUSH-POPELLER-->
        <!--POPUP-ADBOOTH-->
        <script>
    ...
    <!--HEADER-->
			...
			<div class="uk-container">
				<nav id="navbar" data-uk-navbar="mode: click;">
                    ...
                    <ul class="uk-navbar-nav nav-right-custom">
                        ...
                        <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/tv/">TV</a></li>
      ...
      <h1 class="uk-heading-bullet">SlowD Player</h1>
      <hr>
    ...
    <p> <i class="fa fa-info-circle"></i> If the signal is unstable or has stopped working, please report it to an administrator. <a href="http://slowdsports.com/tv/report" class="uk-button uk-button-danger"><i class="fa fa-bug"></i> Report</a>
 </p>
    </div>
      ...
      <!--BUTTON-ADB-->
       <br>
        <div class="uk-child-width-expand@s" uk-grid>
            <div id="1000371570"></div>
        <script>
        window.smrtSB=window.smrtSB||{sections:[]},window.smrtSB.sections.push({s:1000371570,w:300,h:250,c:3, blank: false,cross: true}),window.smrtSB.s||(window.smrtSB.s=document.createElement("script"),window.smrtSB.s.src="//kombm.slowdsports.com/js/"+btoa(37*Math.round((899999*Math.random()+1e5)/37))+".js",window.smrtSB.s.async=!0,document.head.appendChild(window.smrtSB.s));
        </script>
      ...
      <!--PLAYER-ADB-->
        <center>
        <hr>
        <div id="1000371571"></div>
        <script>
        window.smrtSB=window.smrtSB||{sections:[]},window.smrtSB.sections.push({s: 1000371571, w: 854, h: 480, c: 3, type: 6, devices: 'all', blank: false}),window.smrtSB.s||(window.smrtSB.s=document.createElement("script"),window.smrtSB.s.src="//xch.smrtgs.com/js/"+btoa(37*Math.round((899999*Math.random()+1e5)/37))+".js",window.smrtSB.s.async=!0,document.head.appendChild(window.smrtSB.s));
        </script>
        </center>
    <!--/PLAYER-ADB-->
    ...
    <li>
        <a class="uk-accordion-title" href="#">Player - <i>HD</i></a>
        <hr>
        <div class="uk-accordion-content">
            <script type='text/javascript'> str='@3C@69@66@72@61@6D@65@20@77@69@64@74@68@3D@22@31@30@30@25@22@20@68@65@69@67@68@74@3D@22@36@30@30@22@20@73@72@63@3D@22@68@74@74@70@3A@2F@2F@73@6C@6F@77@64@73@70@6F@72@74@73@2E@63@6F@6D@2F@74@76@2F@63@68@61@6E@6E@65@6C@73@2F@73@6C@6F@77@2F@65@6D@62@65@64@2F@65@6E@67@2F@77@6F@72@6C@64@6F@66@66@72@65@65@73@70@6F@72@74@73@2E@70@68@70@22@20@66@72@61@6D@65@62@6F@72@64@65@72@3D@22@30@22@3E@3C@2F@69@66@72@61@6D@65@3E'; document.write(unescape(str.replace(/@/g,'%'))); </script>
        </div>
    </li>
</ul>
       </center>

/*!
   JW Player 8.16.3 Offline Version
   Modified by TRC4 <Albania>
*/
window.jwplayer = function(t) {
    ...
    var r = n(29),
        ...
        u = function() {
            var t = "//ssl.p.jwpcdn.com/player/v/8.16.3/";
    ...
    var r = "8.16.3+commercial_v8-16-3.410.commercial.5804726.hlsjs.e05d84d.hlsjsprogressive.dd9ffc5.jwplayer.3d9fcf6.dai.07e1a38.freewheel.af0c077.googima.4590b72.googimanvmp.6873d1e.headerbidding.058295b.vast.cde933a.analytics.971d006.gapro.141397a"
    ...
    function Z(t) {
        console.warn("The API method jwplayer()." + t + "() is Disabled in the free Edition")
    }
...
// IF YOU WANT TO MOVE PLAYER SOURCES IN ANOTHER PATH JUST SET DESTINACION AT => Player/JW_Player_8_16_3/
    function m(t, e) {
         var n = "file:" === window.location.protocol ? "https:" : "", // HTTP
		//var n = "file:" ===  Object(u.getScriptPath), /* LOCAL FILES */
            r = {
                bidding: "Player/JW_Player_8_16_3/plugins/bidding.js",
				// DEFAULT ENABLED
                //jwpsrv: "Player/JW_Player_8_16_3/jwpsrv.js", // DONT ENABLE THE FUCKING GOOGLE PING.GIF
                dai: "Player/JW_Player_8_16_3/plugins/dai.js",
                vast: "Player/JW_Player_8_16_3/plugins/vast.js",
                googima: e ? "Player/JW_Player_8_16_3/googimanvmp.js" : "Player/JW_Player_8_16_3/plugins/googima.js",
                freewheel: "Player/JW_Player_8_16_3/plugins/freewheel.js",
                gapro: "Player/JW_Player_8_16_3/plugins/gapro.js"
            } [t];
        return r ? n + r : ""
    }
    ...
    var y = function(t, e) {
            ...
            if ("free" === O.edition() && (j = Object(r.j)({
                ...
                }, o.a, Object(r.D)(j, ["aspectratio", "base", "file", "height", "playlist", "sources", "width"]))), j.key = w, j.edition = k, j.error = O.error(), j.generateSEOMetadata = j.generateSEOMetadata || !1, "unlimited" === k) {
// , j.edition = k, j.error = O.error(), j.generateSEOMetadata = j.generateSEOMetadata || !1, "unlimited" === k) {
    ...
    function T(t) {
        return S || (S = function(t) {
            ...
            if (e && r && i) return o = n.e(7).then(function(t) {
                n(147);
                var e = n(71).default;
                return x.a.controls = n(70).default, Object(C.a)(n(151).default), e
    ...
    function V(t) {
        ...
        if (n && n.code === s.a) {
            var r = e.pid,
                i = e.ph,
                o = new s.b(e.key);
				// content.jwplatform.com/libraries/Jq6HIbgz.js
            //if (i > 0 && i < 4 && r && o.duration() > -7776e6) return new I.a("//content.jwplatform.com/libraries/" + r + ".js").load().then((function() {
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			
			 if (i > 0 && i < 4 && r && o.duration() > -7776e6)(u.getScriptPath)("jwplayer.js").load().then((function() {

            //if (i > 0 && i < 4 && r && o.duration() > -7776e6) return new I.a("jwplayer"  || t.base) + ".js").load().then((function() {
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Object(r.j)(ut.prototype, {
        ...
        init: function(t, e) {
            ...
            return i.on("change:errorEvent", at), this.setup.start(e).then((function(t) {
                ...
                if (n.setup) {
                    n.on(_.ub, ct), t.warnings.forEach((function(t) {
                        n.trigger(_.ub, t)
                    }));
...
var jwDefaults = {
    ...
    "displaytitle": false,
    "flashplayer": "jwplayer.flash.swf", // LOCAL
	// "flashplayer": "//ssl.p.jwpcdn.com/player/v/8.16.3/jwplayer.flash.swf", // CDN
    "height": 260,
    "key": "HlUbCfYauSeEHmPJ4hXlskNq5S3XLlNTlSwRxRCSONtX/3c3m8x6qW9KGW1cMRPV",
    "logo": {

! function() {
    ...
    var f = function() {
            function e(t, s, a) {
                d(this, e), this.config = s;
                var o = t.localization.advertising,
                    l = {
                        admessage: o.admessage,
                        podmessage: o.podmessage,
                        cuetext: o.cuetext,
                        loadingAd: o.loadingAd,
                        skipMessage: o.skipmessage,
                        skipText: o.skiptext,
                        debug: !1,
                ...
                this.setOptions(l), this.fwassetid = a.fwassetid || t.fwassetid, this.duration = a.duration || t.duration || 0, this.adschedule = a.adschedule || null;
                var u = a.freewheel || {},
                    h = this.config.freewheel || {};
                this.profileid = u.profileid || h.profileid, this.sectionid = u.sectionid || h.sectionid, this.networkid = u.networkid || h.networkid, this.serverid = u.serverid || h.serverid, this.custom = u.custom || h.custom || {}
            }
            return h(e, [{
                key: "getSchedule",
                value: function() {
                    ...
                    Object.keys(e).forEach((function(i) {
                        ...
                        if (void 0 !== r) {
                            if ("boolean" !== s && "number" !== s || (r = function(e) {
                                    ...
                                    var t = parseFloat(e);
                                    return isNaN(t) ? e : t
                                }(r)), l(r) !== s) throw new Error("invalid parameter: " + i + " should be a " + s);
                            t[i] = r
                        } else t[i] = n
    ...
    function v(e, t) {
        if (p) return p;
        if (window.tv && tv.freewheel) return p = Promise.resolve();
        var i = document.location.protocol,
            r = "file:" === i || "https:" === i ? "https://mssl.fwmrm.net/libs/adm/6.33.0/AdManager.js" : "http://adm.fwmrm.net/libs/adm/6.33.0/AdManager.js",
            n = new e.scriptloader(t || r);
        return p = n.load().then((function() {}))
    }
    var m = {};
    var g = function() {
        function e(t, i) {
            d(this, e), t.extend(this, i), this.isMuted = !1, this.vol = 0, this.freewheelProxy = null
        }
        return h(e, [{
            key: "setProxy",
            value: function(e) {
    ...
    var _ = function() {
            function e(t, i) {
                d(this, e), this.player = t, this.options = i
            }
            return h(e, [{
                key: "getTagMap",
                value: function(e) {
                    ...
                    return r.foreach(function(e, t, i) {
                        ...
                        return t.foreach(e, (function(e, n) {
                            var s = {},
                                a = n;
                            n.ad && (a = n.ad), s.offset = w(a.offset || a.position || n.offset || "", t, i), s.tag = a.tag, a.customadunitname && (s.customadunitname = a.customadunitname), s.type = a.type || n.type || "linear,nonlinear", void 0 !== a.skipoffset && (s.skipoffset = a.skipoffset), r[e] = s
                        })), r
                    }(e, r, i._), (function(e, s) {
                        var a = E(s.offset, r, i._);
                        if (i._.isString(a) && (a = parseFloat(a.replace("pre", "0").replace("post", "-1"))), i._.isNumber(a)) {
                            var o = {
                                tagName: y(s.tag, i, t.options),
                                type: s.type
                            };
        ...
        A = function() {
            function e(t, i, r) {
                d(this, e), this.responsePromise = null, this.streamType = r, this.adsManager = new tv.freewheel.SDK.AdManager, this.adsManager.setNetwork(i.networkid), this.adsManager.setServer(i.serverid), this.options = i || {}, this.version = t, this.schedule = null, this.tagMap = {}, this._fwassetid = null, this._fwduration = 0
            }
            return h(e, [{
                key: "open",
                value: function(e, t) {
                    ...
                    var n = r.getSchedule();
                    if (!n) return this.responsePromise = Promise.reject(), this.responsePromise;
                    S[r.sectionid] || (S[r.sectionid] = Math.floor(2147483648 * Math.random()));
                    var s = S[r.sectionid];
                    this.currentAdContext = this.adsManager.newContext(), this.currentAdContext.setProfile(r.profileid);
                    var a = r.freewheel ? r.freewheel.sfid : null;
                    if (this.currentAdContext.setSiteSection(r.sectionid, null, s, null, a), this.currentAdContext.addKeyValue("customTargetingKey", "JSAMDemoPlayer"), this._fwassetid = r.fwassetid, this._fwduration = r.duration, this.schedule = n, this.responsePromise = new Promise((function(e, t) {
                            i.currentAdContext.addEventListener(tv.freewheel.SDK.EVENT_REQUEST_COMPLETE, e), i.currentAdContext.addEventListener(tv.freewheel.SDK.EVENT_ERROR, t)
                        })), "string" == typeof n) this.currentAdContext.addTemporalSlot(n, tv.freewheel.SDK.ADUNIT_PREROLL, 0);
                    else
                        for (var o = new _(e, t), l = this.tagMap = o.getTagMap(n), d = Object.keys(l), u = 0; u < d.length; u++) {
                            var h = parseInt(d[u]),
                                c = l[h].tagName,
                                f = l[h].customAdUnitName,
                                p = null;
                            if ("overlay" === l[h].type) {
                                if (-1 === h) continue;
                                p = tv.freewheel.SDK.ADUNIT_OVERLAY
                            }
                            if (!p) switch (h) {
                                case 0:
                                    p = f || tv.freewheel.SDK.ADUNIT_PREROLL;
                                    break;
                                case -1:
                                    p = f || tv.freewheel.SDK.ADUNIT_POSTROLL, h = r.duration || 1;
                                    break;
                                default:
                                    p = f || tv.freewheel.SDK.ADUNIT_MIDROLL
                            }
                            this.currentAdContext.addTemporalSlot(c, p, h)
                        }
                    var v = r.custom;
                    for (var m in v) Object.prototype.hasOwnProperty.call(v, m) && this.currentAdContext.addKeyValue(m, v[m]);
    ...
    function k(t, i) {
        var r, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
            s = (c(r = {}, tv.freewheel.SDK.TIME_POSITION_CLASS_PREROLL, "pre"), c(r, tv.freewheel.SDK.TIME_POSITION_CLASS_MIDROLL, "mid"), c(r, tv.freewheel.SDK.TIME_POSITION_CLASS_POSTROLL, "post"), c(r, tv.freewheel.SDK.TIME_POSITION_CLASS_OVERLAY, "overlay"), c(r, tv.freewheel.SDK.TIME_POSITION_CLASS_DISPLAY, "display"), r);
        return {
            type: t,
            client: e,
            adposition: s[n] || T(i),
    ...
    var I = function() {
        function t(e, i, r, n, s) {
            var a = this;
            d(this, t), r.utils.extend(this, r.Events), this.item = e, this.options = i, this.streamType = s, this.player = r, this.utils = r.utils, this.style = r.utils.style, this.environment = r.getEnvironment(), this.instreamProvider = n, this.initAdsManagerPromise = null, this.adsLoadedPromise = null, this.blockingInstreamPlayer = null, this.video = null, this.timeoutAdStart = -1, this.timeoutAdLoad = -1, this.adBlockTimeout = -1, this.progressIntervalId = -1, this.nonlinearContainerId = null, this.slots = {
                prerolls: [],
                midrolls: [],
                postrolls: []
        ...
        return h(t, [{
            ...
            value: function() {
                var t = this;
                this.initAdsManagerPromise = v().then((function() {
                    return t.destroyed() ? null : (t.adsLoaderManager = new A(t.player.version, t.options, t.streamType), t.player.trigger("adManager", {
                        adManager: t.adsLoaderManager.adsManager
                    }), t.player.trigger("adsManager", {
                        adsManager: t.adsLoaderManager.adsManager
                    }), t.adsLoaderManager)
                })).catch((function(e) {
                    return t.asyncError(e)
                })), this.adsLoadedPromise = this.initAdsManagerPromise.then((function() {
                    return t.adsLoaderManager.open(t.player, t.options)
                })).then((function(i) {
                    if (t.destroyed()) return null;
                    if (i.success) {
                        t.trigger("adRequest", {
                            client: e,
                            networkid: i.response.networkId
                        });
                        var r = t.adsLoaderManager.currentAdContext;
                        t.instreamProvider.setProxy(r);
                        for (var n = r.getTemporalSlots(), s = [], a = 0; a < n.length; a++) {
                            var o = n[a];
                            switch (o.getTimePositionClass()) {
                                case tv.freewheel.SDK.TIME_POSITION_CLASS_PREROLL:
                                    t.slots.prerolls.push(o);
                                    break;
                                case tv.freewheel.SDK.TIME_POSITION_CLASS_OVERLAY:
                                    t.slots.midrolls.push(o);
                                    break;
                                case tv.freewheel.SDK.TIME_POSITION_CLASS_MIDROLL:
                                    t.slots.midrolls.push(o), s.push({
                                        begin: o.getTimePosition(),
                                        text: t.options.cuetext,
                                        cueType: "ads"
                                    });
                                    break;
                                case tv.freewheel.SDK.TIME_POSITION_CLASS_POSTROLL:
                                    t.slots.postrolls.push(o)
                            }
                        }
                        t.player.addCues(s), t.registerEvents(r), r.setParameter(tv.freewheel.SDK.PARAMETER_RENDERER_VIDEO_DISPLAY_CONTROLS_WHEN_PAUSE, !1, tv.freewheel.SDK.PARAMETER_LEVEL_GLOBAL)
                    } else t.asyncError(i);
                    return t.slots.prerolls.length && t.utils.addClass(t.player.getContainer(), "jw-flag-ads-freewheel"), i
                })).catch((function(e) {
                    return t.asyncError(e)
                }))
            }
            ...
            value: function(e) {
                ...
                i !== tv.freewheel.SDK.TIME_POSITION_CLASS_OVERLAY && (this.player.trigger("adBreakStart", k("adBreakStart", this.player, i)), this.blockingInstreamPlayer.on("destroyed", (function() {
                    t.player.trigger("adBreakEnd", k("adBreakEnd", t.player, i))
                })))
            }
        }, {
            key: "adImpression",
            ...
            value: function() {
                ...
                clearTimeout(this.timeoutAdLoad), clearTimeout(this.timeoutAdStart), this.timeoutAdStart = setTimeout((function() {
                    if (!e.destroyed()) {
                        ...
                        t.message = "Ad Error: Creative timeout", e.trigger(a, t), e.currentSlot.skipCurrentAd()
                    }
            ...
            value: function(e) {
                ...
                r && this.isPreroll(this.adEventObject(r)) && (this._qoe.tick("adError"), i.timeLoading = this._qoe.between("adLoading", "adError")), this.trigger(a, i)
            }
        }, {
            key: "updateAdPosition",
            value: function(e) {
                this.instreamProvider && this.instreamProvider.trigger(s, {
                ...
                if (!this.blockingInstreamPlayer) {
                    this._qoe.tick("adLoading"), clearTimeout(this.timeoutAdLoad), clearTimeout(this.timeoutAdStart), clearTimeout(this.adBlockTimeout), this.timeoutAdLoad = setTimeout((function() {
                        if (!t.destroyed()) {
                            ...
                            e.message = "Ad Error: Request timeout", t.trigger(a, e), t.stopBlocking()
                        }
    ...
    function P(e) {
        ...
        function w(e, t) {
            var n = e.item,
                s = new f(i.getConfig(), r || {}, n);
            E(),
                function(e) {
                    var t = e.getAdRules(),
                        i = 0 === t.frequency && 1 === c,
                        r = c >= t.startOn && (c - t.startOn) % t.frequency == 0;
                    return i || r
                }(s) ? s.getSchedule() && ((p = new I(n, s, i, u, t)).init(), p.on("all", (function(e, t) {
                    return i.trigger(e, t)
                })), i.once("beforePlay", (function(e) {
                    return p.beforePlay(e)
                }), p).on("resize", (function(e) {
                    var t = e.width,
                        i = e.height;
                    return p.resize(t, i)
                }), p).on("fullscreen", (function() {
                    return p.resize()
                }), p).on("all", _, p)) : s.adschedule = null
        }

        function _(e, t) {
            e === s ? p.time(t) : "beforeComplete" === e && p.beforeComplete()
        }
        o.extend(this, i.Events), this.version = "2.2.11", i.pauseAd = function(e, t) {
            p && (e ? p.pause(t || {}) : p.resume(t || {}))
        }, i.skipAd = function() {
            p && p.adSkip()
        }, i.on("ready", (function() {
            v().catch((function() {
            ...
            c++, w(e, e.item.streamtype || l.streamtype)
        ...
        var S = function(r, s) {
                y(), i.off(null, null, n), i.playAd = o.noop, i.trigger(a, {
                    id: t,
                    client: e,
                    message: r,
                    code: 900,
            ...
            A = function(e, t, i) {
                var r = m[t];
                return r || (m[t] = new Promise((function(r, n) {
                    ! function(i) {
                        var r = new e.key(t);
